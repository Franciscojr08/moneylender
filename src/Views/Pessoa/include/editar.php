		...
		<div class="modal-content">
			...
			<div class="modal-body cad_emp_data" style="width: 100%;">
				<div class="d-flex justify-content-between" style="padding-bottom: 1.2rem;">
					<div style="width: 50%;">
						<label>Nome</label><br>
						<input style="width: 100%" type="text" name="aPessoa[psa_nome]" placeholder="Nome" required value="<?php echo $oPessoa->getNome(); ?>">
					</div>

					<div>
						<label>CPF</label><br>
						<input type="text" class="cpf_edicao" name="aPessoa[psa_cpf]" placeholder="CPF" maxlength="14" value="<?php echo $oPessoa->hasCPF() ? $oPessoa->getCPF() : ""; ?>">
					</div>
				</div>
				...
				<div class="d-flex justify-content-between" style="padding-bottom: 1.2rem;">
					<div style="width: 50%;">
						...
						<input style="width: 100%" type="text" name="aPessoa[psa_logradouro]" placeholder="Logradouro" value="<?php echo $oPessoa->hasLogradouro() ? $oPessoa->getLogradouro() : ""; ?>">
					</div>

					<div>
						<label>Bairro</label><br>
						<input type="text" name="aPessoa[psa_bairro]" placeholder="Bairro" value="<?php echo $oPessoa->hasBairro() ? $oPessoa->getBairro() : ""; ?>">
					</div>
				</div>
				...
				<div class="d-flex" style="padding-bottom: 1.2rem;">
					<div style="width: 22.5%;">
						...
						<input style="width: 100%;" type="text" name="aPessoa[psa_cidade]" placeholder="Cidade" value="<?php echo $oPessoa->hasCidade() ? $oPessoa->getCidade() : ""; ?>">
					</div>

					<div style="width: 22.5%; margin-left: 5%">
						<label>Estado</label><br>
						<input style="width: 100%;" type="text" name="aPessoa[psa_estado]" placeholder="Estado" value="<?php echo $oPessoa->hasEstado() ? $oPessoa->getEstado() : ""; ?>">
					</div>

					<div style="width: 34%; margin-left: 16%">
						<label>Complemento</label><br>
						<input style="width: 100%;" type="text" name="aPessoa[psa_complemento]" placeholder="Complemento" value="<?php echo $oPessoa->hasComplemento() ? $oPessoa->getComplemento() : ""; ?>">
					</div>
				</div>
				...
				<div class="d-flex justify-content-between" style="padding-bottom: 1.2rem;">
					<div style="width: 50%;">
						...
						<input style="width: 100%" type="email" name="aPessoa[psa_email]" placeholder="E-mail" value="<?php echo $oPessoa->hasEmail() ? $oPessoa->getEmail() : ""; ?>">
					</div>

					<div>
						<label>Telefone</label><br>
						<input type="text" class="telefone_edicao" name="aPessoa[psa_telefone]" placeholder="Telefone" value="<?php echo $oPessoa->hasTelefone() ? $oPessoa->getTelefone() : ""; ?>">
					</div>
				</div>
				...
				<div class="d-flex">
					<div style="width: 22.5%; border: none; border-bottom: 1px solid rgba(0, 0, 0, 0.1);">
						...
						<input type="radio" <?php echo $oPessoa->isIndicado() ? "checked" : ""; ?> id="sim_edicao" name="aPessoa[psa_indicado]" class="psa_indicado_edit" value="1">
						<label for="sim_edicao" style="margin-right: 15px; color: rgba(0, 0, 0, 0.8);">Sim</label>
						<input type="radio" <?php echo $oPessoa->isIndicado() ? "" : "checked"; ?>  id="nao_edicao" name="aPessoa[psa_indicado]" class="psa_indicado_edit" value="2">
						<label for="nao_edicao" style="color: rgba(0, 0, 0, 0.8);">Não</label><br>
					</div>

					<div id="div_indicador_edit" style="width: 73%; margin-left: 5%; display: <?php echo $oPessoa->isIndicado() ? "block" : "none"; ?>">
						<label>Nome Indicador</label><br>
						<input style="width: 100%;" type="text" class="nome_indicador_antigo" name="aPessoa[psa_nome_indicador]" placeholder="Nome Indicador" value="<?php echo $oPessoa->isIndicado() ? $oPessoa->getNomeIndicador() : ""; ?> ">
					</div>
				</div>
			</div>

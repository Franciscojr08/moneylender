...
<div style="width: 54.5%; border-bottom: 1px solid rgba(0, 0, 0, 0.1);">
	...
	<input type="radio" checked id="filtro_recibo_nao" name="aFiltro[rel_recibo][filtro_recibo_pessoa]" class="emo_tipo_pessoa_recibo" value="1">
	<label for="filtro_recibo_nao" style="margin-right: 15px; color: rgba(0, 0, 0, 0.8);">Cliente</label>
	<input type="radio" id="filtro_recibo_sim" name="aFiltro[rel_recibo][filtro_recibo_pessoa]" class="emo_tipo_pessoa_recibo" value="2">
...
<div id="recibo_cliente" style="width: 54.5%; padding: 1.2rem 0;">
	...
	<select style="width: 100%;" id="filtro_recibo_cliente" class="select_emp_data" name="aFiltro[rel_recibo][cliente_id]" required>
...
<div id="recibo_fornecedor" style="display: none; width: 54.5%; padding: 1.2rem 0;">
	...
	<select style="width: 100%;" id="filtro_recibo_fornecedor" class="select_emp_data" name="aFiltro[rel_recibo][fornecedor_id]">
...
<div id="fornecedor_emp" style="width: 54.5%; padding-bottom: 6.9rem;">
	...
	<select style="width: 100%;" id="filtro_recibo_emprestimo" name="aFiltro[rel_recibo][filtro_recibo_emprestimo]" class="select_emp_data" required>
